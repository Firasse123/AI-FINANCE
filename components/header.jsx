  ...
  return ( 
    <div className="fixed top-0 w-full bg-white/80 backdrop-blur-md shadow-md z-50 border-b ">
        <nav className='container mx-auto px-4 py-4 flex items-center justify-between'>
            <Link href="/"><Image src={"/logo.png"} alt="Logo" width={200} height={60} 
            ...
            <SignedIn>
                <Link href={"/dashboard"}>
                  <Button variant="outline">
                    <LayoutDashboard size={18}></LayoutDashboard><span className='hidden md:inline'>Dashboard</span></Button>
                </Link>
                ...
                hover:text-blue-600 flex items-center gap-2'>
                  <Button  className="flex items-center gap-2">
                    <PenBox size={18}></PenBox><span className='hidden md:inline'>Add Transaction</span></Button>
                </Link>
            </SignedIn>
